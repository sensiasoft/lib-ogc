...
public abstract class SPSTestCase extends OWSTestCase
{   

    protected void readWriteCompareXmlRequest(String path, DataComponent sweParams) throws Exception
    {
        SPSUtils utils = new SPSUtils();
        
        InputStream is = getClass().getResourceAsStream(path);
        DOMHelper dom1 = new DOMHelper(is, false);
        OWSRequest request1 = utils.readSpsRequest(dom1, dom1.getBaseElement(), sweParams);
        is.close();
