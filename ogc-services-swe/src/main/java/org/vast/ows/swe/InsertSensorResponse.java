...
public class InsertSensorResponse extends OWSResponse
{
    ...
    {
        return assignedProcedureId;
    }


    public void setAssignedProcedureId(String procedureId)
    {
        this.assignedProcedureId = procedureId;
    }
    ...
    public void setAssignedOffering(String offeringId)
    {
        this.assignedOffering = offeringId;
    }
}
