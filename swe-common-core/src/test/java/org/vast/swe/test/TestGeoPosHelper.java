...
public class TestGeoPosHelper
{
    ...
    {
        // orientation vectors
        utils.writeComponent(System.out, fac.newEulerOrientationENU(SWEConstants.DEF_SENSOR_ORIENT, "deg"), false, true);
        utils.writeComponent(System.out, fac.newEulerOrientationNED(SWEConstants.DEF_SENSOR_ORIENT, "rad"), false, true);
        utils.writeComponent(System.out, fac.newEulerOrientationECEF(SWEConstants.DEF_PLATFORM_ORIENT, "mrad"), false, true);
