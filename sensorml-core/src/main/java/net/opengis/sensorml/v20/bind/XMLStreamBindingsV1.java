...
public class XMLStreamBindingsV1 extends AbstractXMLStreamBindings
{
    public final static String NS_URI = "http://www.opengis.net/sensorML/1.0.1";
    ...
    public XMLStreamBindingsV1(Factory factory, net.opengis.swe.v20.Factory ns1Factory, net.opengis.gml.v32.Factory ns2Factory,
            org.isotc211.v2005.gmd.Factory ns3Factory, org.isotc211.v2005.gco.Factory ns4Factory)
    {
        this.factory = factory;
        ns1Bindings = new SWEStaxBindings(ns1Factory);
                    ...
                    if (found)
                    {
                        ...
                        if (!componentProp.hasValue())
                        {
                            ...
                            componentProp.setHrefResolver(new HrefResolverXML(baseURI) {
                                ...
                                {
                                    componentProp.setValue(XMLStreamBindingsV1.this.readAbstractProcess(reader));                                    
                                }                                
                            });
                        }
    ...
    {
        boolean found = checkElementName(reader, "System");
        if (!found)
            throw new XMLStreamException(ERROR_INVALID_ELT + reader.getName() + errorLocationString(reader));
    ...
    {
        writer.writeStartElement(NS_URI, "System");
        this.writeNamespaces(writer);
    ...
    {
        boolean found = checkElementName(reader, "ProcessChain");
        if (!found)
            throw new XMLStreamException(ERROR_INVALID_ELT + reader.getName() + errorLocationString(reader));
    ...
    {
        writer.writeStartElement(NS_URI, "ProcessChain");
        this.writeNamespaces(writer);
    ...
    public AbstractProcess readAbstractProcess(XMLStreamReader reader) throws XMLStreamException
    {
        ...
        if ("ProcessModel".equals(localName))
            return readSimpleProcess(reader);
        else if ("ProcessChain".equals(localName))
            return readAggregateProcess(reader);
