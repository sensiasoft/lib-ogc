...
public class BinaryTemporalOpTypeBinding extends AbstractComplexBinding {
    ...
    public Object getProperty(Object object, QName name) throws Exception {
        Expression e = FESParseEncodeUtil.getProperty((BinaryTemporalOperator) object, name);
    ...
    public List getProperties(Object object, XSDElementDeclaration element) throws Exception {
        ...
        Literal literal = (Literal) ((BinaryTemporalOperator)object).getExpression2();
        literalValues.add(new Object[] {org.geotools.gml3.v3_2.GML.AbstractTimeGeometricPrimitive, ((Literal)literal).getValue()});
