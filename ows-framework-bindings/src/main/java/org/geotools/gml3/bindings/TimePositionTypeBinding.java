...
public class TimePositionTypeBinding extends AbstractComplexBinding {
    ...
    public Object parse(ElementInstance instance, Node node, Object value) throws Exception {
        String indeterminateCode = (String)node.getAttributeValue("indeterminatePosition");
        if (indeterminateCode != null) {
            DefaultTemporalPosition tempPos = new DefaultTemporalPosition(null, IndeterminateValue.valueOf(indeterminateCode));
            return new DefaultPosition(tempPos);
        }
        return value;
    }
